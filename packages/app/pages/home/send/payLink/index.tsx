 ...
 * @LastEditors: yosan
 * @LastEditTime: 2025-02-25 18:21:32
...
const PayLinkScreen = () => {
  ...
  return (
    <PermissionPage>
      ...
      {isSuccess ? (
        <YStack flex={1}>
          <SuccessInfo type={'sent'} orderData={demoOrderData} />
        ...
        <YStack flex={1} pl={appScale(24)} pr={appScale(24)}>
          <YStack w="100%" mb={appScale(24)}>
            ...
            <Button
              ...
              onPress={() => {
                push(
                  `/home/send?userId=${params?.userId}&token=${params?.token}&chain=${params?.chain}&amount=${params?.amount}`,
                );
              }}
            >
      ...
      >
        ...
        >
          {isSuccess ? t('home.send.copyLink') : t('home.paylink.sendCrypto')}
        </AppButton>
      </XStack>
