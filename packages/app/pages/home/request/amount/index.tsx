 ...
 * @LastEditors: yosan
 * @LastEditTime: 2025-02-25 18:21:13
 * @FilePath: /ezgg-app/packages/app/pages/home/request/amount/index.tsx
 */
import {
  AppHeader,
  AppHeaderProps,
...
const AmountScreen = () => {
  ...
  const submit = () => {
    ...
    setTimeout(() => {
      ...
      push(`/home/request/paylink?userId=${params?.userId}&token=${token}&chain=${chain}&amount=${inputValue}`);
    }, 2000);
  ...
  return (
    <PermissionPage>
      <AppHeader2 title={t('screen.home.amountRequesting')} fallbackUrl="/" />
        ...
        <YStack w="100%" mb={appScale(24)}>
          <XStack mb={appScale(8)} w="100%">
            <SizableText h={appScale(30)} lh={appScale(30)} fontSize={'$5'} color={'#212121'} fontWeight={'600'}>
              {t('home.request.amountRequesting')}
            </SizableText>
          </XStack>
