 ...
 */
export default {
  'login.loginButton':  'Log in or Sign up',
  'login.loginTips1': 'Sign in Successful!',
  ...
  'login.loginAgreement1':
    'You consent to receive account notifications from Ezgg. Text & data rates may apply Message frequency varies. Reply STOP to unsubscribe. See',
