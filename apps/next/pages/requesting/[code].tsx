 ...
 * @FilePath: /ezgg-app/apps/next/pages/requesting/[code].tsx
 */
...
export default function Page() {
  ...
  return (
    <>
      <Head>
        <title>{t('home.requesting.title')}</title>
        <meta property="og:title" content={t('home.requesting.title')} />
        <meta property="og:description" content={t('home.requesting.description')} />
        <meta property="og:image" content={`${ExternalLinkData?.webPageHome}/images/logo.png`} />
        <meta property="og:url" content={`${ExternalLinkData?.webPageHome}/home/requesting/${params?.code}`} />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content={AppName} />
        <meta property="og:locale" content={locale} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta property="og:title" content={t('home.requesting.title')} />
        <meta name="twitter:description" content={t('home.requesting.description')} />
        <meta name="twitter:image" content={`${ExternalLinkData?.webPageHome}/images/logo.png`} />
        <meta name="twitter:url" content={`${ExternalLinkData?.webPageHome}/home/requesting/${params?.code}`} />
